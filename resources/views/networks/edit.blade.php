        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('networks.update', $network) }}" class="space-y-6">
                ...
                <x-form-section
                    ...
                    description="Actualiza el nombre y descripción de tu red"
                ...
                >
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            >{{ old('description', $network->description) }}</textarea>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-6">
                            <input
                                ...
                                type="checkbox"
                                value="1"
                                {{ old('allow_member_invites', $network->allow_member_invites) ? 'checked' : '' }}
                ...
                <div class="flex justify-between items-center">
                    <form method="POST" action="{{ route('networks.destroy', $network) }}" onsubmit="return confirm('¿Estás seguro de eliminar esta red? Esta acción no se puede deshacer.');">
                        @csrf
                        @method('DELETE')
                        <button
                            type="submit"
